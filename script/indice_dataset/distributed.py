...
class _TorchDistributedEnvironment:
    ...
    def _set_from_slurm_env(self):
        ...
        if "MASTER_ADDR" not in os.environ:
            ...
            print(" @ Using master addr: ", self.master_addr, " @", self.local_rank)
        else:
        ...
        if "MASTER_PORT" not in os.environ:
            ...
            print(" @ Using master port: ", self.master_port, " @", self.local_rank)
        else:
        ...
        if "LOCAL_RANK" not in os.environ:
            print(" @ Using local rank: ", self.local_rank, " +++++++++")
    ...
    def fix_on_juwels(self):
        # From my colleague, this is not really necessary
        if "juwels" in self.master_addr:
            _split = self.master_addr.split(".")
            if len(_split) == 2 and _split[1] == "juwels" and _split[0][-1] != "i":
                self.master_addr = _split[0] + "i" + "." + _split[1]
